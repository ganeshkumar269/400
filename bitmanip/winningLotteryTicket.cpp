...
int main()
{
    ...
    for(string i : t){
        ...
        for(char j : i){
            switch(j){
                case '0' : k = k | (1 << 0);break;
                case '1' : k = k | (1 << 1);break;
                case '2' : k = k | (1 << 2);break;
                case '3' : k = k | (1 << 3);break;
                case '4' : k = k | (1 << 4);break;
                case '5' : k = k | (1 << 5);break;
                case '6' : k = k | (1 << 6);break;
                case '7' : k = k | (1 << 7);break;
                case '8' : k = k | (1 << 8);break;
                case '9' : k = k | (1 << 9);break;
            }
        }
    }
    cout << (1 << 0) << endl;
